...
RUN conda config --add channels defaults && conda config --add channels bioconda && conda config --add channels conda-forge && conda install -c bioconda htslib && conda install ivar && conda clean -a
